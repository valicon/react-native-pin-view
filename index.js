...
const PinView = React.forwardRef(
  (
    {
      buttonTextByKey = defaultButtonTextByKey,
      accessible = true,
      style,
      onButtonPress = () => {},
      onValueChange,
      ...
      inputSize = 40,
      disabled = false,
      customLeftButton = false,
      customRightButton = false,
      customRightAccessibilityLabel = "confirm",
      customLeftAccessibilityLabel = "clear",
